    ...
    <div>
      ...
      <div className="max-w-md mx-auto p-4 space-y-4 bg-white rounded-lg shadow-md">
        ...
        <div className="flex space-x-4 mt-4 justify-between">
          <button className="px-4 py-2 bg-blue-300 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
            Cancel
          </button>
          <button className="px-4 py-2 bg-pink-500 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500">
            Next
          </button>
        </div>
      </div>
